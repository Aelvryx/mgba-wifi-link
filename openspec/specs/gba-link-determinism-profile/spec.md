# GBA Link Determinism Profile Specification

## Purpose

Define the canonical configuration, capability, RTC, external-input, and lifecycle invariants required for deterministic replicated GBA link play.
