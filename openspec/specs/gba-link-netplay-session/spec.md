# GBA Link Netplay Session

## Purpose
Define the libretro Netpacket lifecycle, compatibility, attachment, transport safety, diagnostics, and frontend protections for a deterministic two-device GBA link session.
