# GBA Link Runtime Selection Specification

## Purpose

Define the sole shipped GBA Wi-Fi link runtime, the retirement boundary for protocol v1, and the regression and historical-evidence guarantees that survive its removal.
