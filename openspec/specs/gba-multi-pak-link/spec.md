...
## Purpose
Define the supported two-player GBA MULTI cable topology, conservative virtual-time coordination, transfer protocol, completion behavior, and deterministic failure semantics.
